...
DEFAULT_REQUIRED_MODULES: tuple[str, ...] = (
    ...
    "arabic_engine.signal.unicode_norm",
    "arabic_engine.morphology.root_pattern",
    "arabic_engine.morphology.transition",
    "arabic_engine.morphology.functional_transition",
    "arabic_engine.morphology.aeu",
    "arabic_engine.semantics.ontology",
    "arabic_engine.semantics.ontology_v1",
    "arabic_engine.semantics.dalala",
