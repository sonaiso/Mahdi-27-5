...
> **الوثيقة السيادية العليا**: انظر [`docs/project_goals_and_proof_objectives_constitution_v1.md`](docs/project_goals_and_proof_objectives_constitution_v1.md) — دستور أهداف المشروع ومقاصده البرهانية (PGPO-v1). هذا هو المرجع الأعلى لكل خطة تنفيذية وعقد طبقي واختبار ومواصفة معمارية.
